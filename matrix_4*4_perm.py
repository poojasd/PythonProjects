...
#changes made
					for n5 in range(min, max+1):
						for n6 in range(min, max+1):
							for n7 in range(min, max+1):
								for n8 in range(min, max+1):

									for n9 in range(min, max+1):
										for n10 in range(min, max+1):
											for n11 in range(min, max+1):
												for n12 in range(min, max+1):
													for n13 in range(min, max+1):
															for n14 in range(min, max+1):		
																for n15 in range(min, max+1):
																	for n16 in range(min, max+1):
#changes made
